...
Revision ID: e8bb0342595c
Revises: d8f3087f2b54
Create Date: 2025-06-12 07:34:55.390240
...
revision: str = "e8bb0342595c"
down_revision: Union[str, None] = "d8f3087f2b54"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "email", sa.String(length=255), nullable=False, unique=True
