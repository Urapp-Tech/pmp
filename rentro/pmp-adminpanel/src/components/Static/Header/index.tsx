      ...
      <div className="max-w-full mx-auto px-10">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:block">
            <ul className="flex gap-8 items-center text-[17px] font-light text-primary">
              <li>
          ...
          {isLogin ? (
            <div className="hidden md:flex items-center justify-end">
              <Link
                ...
                className="text-[17px] font-light no-underline text-primary border-2 border-primary px-6 py-2 rounded-lg"
              >
                Sign In
              </Link>
            </div>
