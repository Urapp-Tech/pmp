    ...
    <div className="bg-gradient-to-br flex flex-col items-center justify-center mt-3">
      <Card className="w-full max-w-3xl rounded-3xl shadow-2xl border border-scrollbar">
        <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              src={
                user.profilePic
                  ...
                  : 'https://ui-avatars.com/api/?name=' +
                    encodeURIComponent(user.name + ' ' + user.name)
              }
              alt="Profile"
          ...
          <p className="text-primary-bg text-base mt-1">{user.email}</p>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full text-left">
            <div className="bg-secondary-bg rounded-xl p-4 shadow-inner">
              <p className="text-primary-bg text-base">Account Status</p>
              <p className="text-primary-bg text-sm font-[300]">
                {user.isActive ? 'Active' : 'Inactive'}
              </p>
            </div>
            <div className="bg-secondary-bg rounded-xl p-4 shadow-inner">
              <p className="text-primary-bg text-base">Gender</p>
              <p className="text-primary-bg text-sm font-[300]">
                {user.gender}
              </p>
            </div>
            <div className="bg-secondary-bg rounded-xl p-4 shadow-inner">
              <p className="text-primary-bg text-base">Phone</p>
              <p className="text-primary-bg text-sm font-[300]">{user.phone}</p>
            </div>
            <div className="bg-secondary-bg rounded-xl p-4 shadow-inner">
              <p className="text-primary-bg text-base">Role Name</p>
              <p className="text-primary-bg text-sm font-[300]">
                {user.roleName}
              </p>
            </div>
