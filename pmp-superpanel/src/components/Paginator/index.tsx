    ...
    <Pagination>
      <PaginationContent className="bg-earth-bg h-[51px] rounded-[30px] flex items-center justify-center gap-2">
        ...
        {showPreviousNext && (
          <PaginationItem>
            <PaginationNext
              className={`${total === cpage ? 'bg-primary-bg text-white rounded-[50%] hover:bg-mars-bg/50 hover:text-lunar-bg' : 'cursor-pointer bg-primary-bg text-white rounded-[50%] hover:bg-scrollbar hover:text-primary-bg'}`}
