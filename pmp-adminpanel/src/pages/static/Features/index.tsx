  ...
  return (
    <>
      ...
      <div className="w-full relative bg-[#DFF4EC]">
        ...
        <motion.section
          ref={heroRef}
          className="relative h-[100vh] flex justify-start max-[1260px]:h-[900px] max-[1260px]:flex-col max-[1260px]:gap-[] max-[1260px]:items-center max-[992px]:h-[700px]"
          style={{ y: bgY }}
        >
          <img
          ...
          <div className="relative h-full flex-1 flex w-full">
            <motion.div
              className="flex-1 flex absolute bottom-40 max-w-[1200px] gap-10 items-center justify-between px-4 max-[1260px]:flex-col max-[1260px]:items-start"
              style={{ y: contentY }}
            >
              <motion.h1
                className="capitalize text-[100px] font-normal leading-1 text-primary max-[1260px]:text-[70px] max-[1024px]:text-[50px]"
              ...
              <motion.p
                className="max-w-[593px] font-light text-[24px] text-primary  max-[1024px]:text-[20px]"
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
