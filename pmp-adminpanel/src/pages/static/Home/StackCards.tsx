...
//   const y = useTransform(scrollYProgress, ranges.progressRange, ranges.yRange);
...
//         <h3 className="stacked-card__title">{card.title}</h3>
//         <p className="stacked-card__description">{card.description}</p>
//       </div>
//       {card.imageSrc && (
...
// export const StackedCards: FC<StackedCardsProps> = ({ title, cards }) => {
...
//     {
//       progressRange: [0.5, 0.66],
//       yRange: ["0%", "-20%"],
//       rotateRange: [0, 0],
//       scaleRange: [1, 1],
//     },
//     {
//       progressRange: [0, 0.66],
//       yRange: ["200vh", "0%"],
//       rotateRange: [-20, 0],
//       scaleRange: [1.2, 1],
//     },
//     {
//       progressRange: [0.6, 0.99],
//       yRange: ["200vh", "18.7%"],
//       rotateRange: [-20, 0],
//       scaleRange: [1.2, 1],
//     },
...
//         {title && (
//           <h2 className="stacked-cards-wrapper__title">{title}</h2>
//         )}
